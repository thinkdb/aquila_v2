# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-27 15:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_nullable', models.CharField(default='---', max_length=3)),
                ('column_key', models.CharField(default='---', max_length=3)),
                ('column_default', models.CharField(default='----', max_length=150)),
                ('extra', models.CharField(default='----', max_length=30)),
                ('PRIVILEGES', models.CharField(max_length=80)),
                ('column_comment', models.CharField(default='----', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procedure', models.OneToOneField(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='model_model.MetaDataProcedure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField()),
                ('table', models.OneToOneField(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='model_model.MetaDataTables')),
            ],
            options={
        ...
        migrations.AlterIndexTogether(
            name='inceptionworkorderinfo',
            index_together=set([('review_user', 'review_status'), ('work_user', 'review_status')]),
        ),
    ]
